...
DATABASES = {
    'default': {
        ...
        'NAME': 'library',#os.path.join(PROJECT_DIR,'database','sqlite3'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '$x5i%z*!)r5=qs^(x(6oxnb3*3w$e#zvz@8vo-&wcex5x_4-1='
